...
#   docker build -t cypress/included:10.8.0 .
#
...
# # Copy kickoff script
# ADD ./startup-entrypoint.sh /home/../startup-entrypoint.sh

# # Add SSH keys for Git checkout
# RUN mkdir -p -m 0700 ~/.ssh && ssh-keyscan github.com >> ~/.ssh/known_hosts
# RUN --mount=type=ssh bundle install

# ENTRYPOINT ["cypress", "run"]
# ENTRYPOINT ["//home/../startup-entrypoint.sh"]
CMD ["/bin/bash"]
